...
export default function Codes() {
  ...
  const filteredAssemblies = assemblyCodes.filter(a => 
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Companies and Assemblies in columns */}
        ...
        {filteredCompanies.length === 0 ? (
          ...
          <div className="space-y-3">
            {filteredCompanies.map((c) => (
              <div key={c.code} className="flex justify-between items-center p-4 border border-gray-200 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
        ...
        {filteredAssemblies.length === 0 ? (
          ...
          <div className="space-y-3">
            {filteredAssemblies.map((a) => (
              <div key={a.code} className="flex justify-between items-center p-4 border border-gray-200 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
